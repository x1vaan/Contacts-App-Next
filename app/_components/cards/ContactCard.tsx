...
export default function ContactCard({ id, number, profile_photo, name, email }: Contacts) {
  return (
    <Card className="rounded-xl transition border-0 bg-cardBgColor text-gray-200 relative">
      <CardHeader className="flex justify-center items-center w-full cursor-pointer">
        ...
        <p className="font-bold text-medium text-center text-greenSpotify">{name}</p>
        <p>{number}</p>
      </CardHeader>
