...
import { Heart, MoreHorizontal, Phone } from "lucide-react";
      ...
      <div className="flex items-end space-x-6 bg-gradient-to-b from-customViolet via-customViolet/40 to-[#121212] p-8">
        ...
        <div>
          ...
          <p className="text-sm opacity-75">
            {session.user?.user} • {data.length} contacts • 2 created this week
          </p>
        </div>
      </div>
          ...
          <Table>
            ...
            <TableBody>
              {[...data].map((contact, i) => (
                ...
                >
                  <TableCell className="font-medium py-2">{contact.id}</TableCell>
